...
- 상태 로그 분리: 제재 로그 채널과 별도 health 로그 채널 설정 가능
...
Health logs can use a separate channel from sanction logs. Use:
...
If no health channel is set, health logs fall back to the sanction log channel.
